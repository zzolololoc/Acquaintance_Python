...
В них хранятся очки каждого участника — вещественные числа с двумя знаками после точки, например 4.03.
...
# finish_command = [first_command[idx] if first_command[idx] > second_command[idx] else second_command[idx] for idx in range(len(first_command))]

finish_command = [(i if i > j else j) for i in first_command for j in second_command]
